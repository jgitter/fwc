...
public class InstitutionSoapServiceImpl implements InstitutionSoapService {
	...
	@Override
	@PayloadRoot(localPart = FindInstitutionsRequest.NAME, namespace = InstitutionSoapService.TARGET_NAMESPACE)
	public @ResponsePayload FindInstitutionsResponse findInstitutions(
			@RequestPayload FindInstitutionsRequest request) throws FwcServiceException {
